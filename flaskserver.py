...
def index():
    if request.method == 'POST' and 'username' in session:
        ...
        auth_session_html=f'<form class="mb-3" action="https://accounts.spotify.com/authorize" method="GET"><input type="hidden" name="client_id" value="{ CLIENT_ID }"><input type="hidden" name="response_type" value="code"><input type="hidden" name="redirect_uri" value="{ REDIRECT_URI }"><input type="hidden" name="scope" value="{ SCOPE_STRING }"><button class="btn btn-success" type="submit">Login to Spotify</button></form>'
...
def callback():
    ...
    if code:
        ...
        if access_token and refresh_token:
            ...
            auth_session_html=f'<form class="mb-3" action="https://accounts.spotify.com/authorize" method="GET"><input type="hidden" name="client_id" value="{{ client_id }}"><input type="hidden" name="response_type" value="code"><input type="hidden" name="redirect_uri" value="{{ redirect_uri }}"><input type="hidden" name="scope" value="{{ scope }}"><button class="btn btn-success" type="submit">Login to Spotify</button></form>'
